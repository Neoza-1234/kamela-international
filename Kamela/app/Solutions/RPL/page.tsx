    ...
    <>
      ...
      <div className="container mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
        <div className="rpl-img-container relative flex justify-around items-center pt-5">
          <Image
            ...
            width={500}
            height={600}
            className="rpl-image rounded-3xl shadow-2xl "
          />
        </div>
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white border border-secondary rounded-3xl p-6 space-y-3 hover:-translate-y-1 transition duration-300 hover:shadow-2xl">
